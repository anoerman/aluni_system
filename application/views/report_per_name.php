...
$objPHPExcel->getProperties()->setCreator("Noerman Agustiyan")
							 ...
							 ->setTitle("Member Report Per Name")
							 ->setSubject("Member Report Per Name")
							 ->setDescription("Showing member data ordered by member name.")
							 ->setKeywords("alumni database php");

// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Member Report Per Name');

// Header Title
$objPHPExcel->getActiveSheet()->setCellValue("B2", $system_name." Report Per Name");
...
header('Content-Disposition: attachment;filename="'.$system_name.'-all-data-report-'.date('d/m/Y').'.xlsx"');
