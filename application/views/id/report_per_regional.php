...
$objPHPExcel->getProperties()->setCreator("Noerman Agustiyan")
							 ...
							 ->setTitle("Laporan Anggota Berdasarkan Regional")
							 ->setSubject("Laporan Anggota Berdasarkan Regional")
							 ->setDescription("Tampilkan semua data anggota berdasarkan Regional.")
							 ->setKeywords("alumni database php");

// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Laporan Anggota Regional');

// Header Title
$objPHPExcel->getActiveSheet()->setCellValue("B2", $system_name." Laporan Per Regional");
...
header('Content-Disposition: attachment;filename="'.$system_name.'-laporan-per-regional-'.date('d/m/Y').'.xlsx"');
