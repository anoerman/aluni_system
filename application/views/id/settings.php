		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-body form-horizontal">
					<div class="container">
						<form class="form form-horizontal" method="post" action="<?php echo site_url("backend_id/setting_process"); ?>" enctype="multipart/form-data">
							...
							<div class="form-group <?php if (form_error('system_name')){echo 'has-error';}; ?>">
								<label for="system_name" class="control-label col-sm-3">Nama Sistem</label>
								<div class="col-sm-6">
									<input type="text" name="system_name" id="system_name" class="form-control" placeholder="Nama Sistem" required="" value="<?php echo $setting_system_name; ?>">
								</div>
							</div>
							<div class="form-group <?php if (form_error('system_location')){echo 'has-error';}; ?>">
								<label for="system_location" class="control-label col-sm-3">Lokasi Sistem</label>
								<div class="col-sm-6">
							...
							<div class="form-group <?php if (form_error('system_description')){echo 'has-error';}; ?>">
								<label for="system_description" class="control-label col-sm-3">Keterangan Sistem</label>
								<div class="col-sm-6">
