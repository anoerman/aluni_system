		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form class="form-horizontal" name="user_setting" id="user_setting" method="post" action="<?php echo site_url("backend_id/user_setting_process"); ?>">
							...
							<div class="col-sm-4">
								<p class="form-control-static">
									...
									if (strpos($privileges, "|")!==false) {
										...
										if ($privileges=="*") {
											$privileges_view .= "Semua Hak Akses";
										}
										else {
											// Get privilege name
											foreach ($module_list->result() as $md) {
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="password" name="current_password" id="current_password" class="form-control" required="" placeholder="Password Sekarang">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="password" name="confirm_new_password" id="confirm_new_password" class="form-control" required="" placeholder="Konfirmasi Password Baru">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-12 text-center"><button class="btn btn-primary" type="submit">Ubah Password</button></div>
						</div>
