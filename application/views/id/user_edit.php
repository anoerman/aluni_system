		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form form-horizontal" method="post" action="<?php echo site_url("backend_id/user_edit_process"); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" name="active" id="active">
									<option value="yes" <?php if($curr_active=="yes"){echo "selected";} ?>>Aktif</option>
									<option value="no" <?php if($curr_active=="no"){echo "selected";} ?>>Tidak Aktif</option>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input name="new_password" id="new_password" class="form-control" type="password" placeholder="Password Baru">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3" for="conf_password">Konfirmasi Password</label>
							<div class="col-sm-5">
								<input name="conf_password" id="conf_password" class="form-control" type="password" placeholder="Konfirmasi Password">
								<span class="help-block">Isi hanya jika anda ingin mengubah password</span>
							</div>
						</div>
						<hr>
						<div class="form-group">
